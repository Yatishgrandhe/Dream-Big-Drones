...
- Screenshot correction, August 12, 2026: the supplied three-page reference is the current visual contract. Home begins with an above-the-fold ivory editorial hero: oversized promise and copper eyebrow on the left, explanatory copy and actions beside it, and an aerial media stage on the right. The hero’s desktop height never exceeds the visible viewport beneath the header. The services grid, navy proof strip, and light closing conversion follow it in the screenshot’s order.
